...
protected:
    ...
    {
        _ASSERT(m_nCount == (T_COUNT)nVal);
    }
    void zSwapCount(InhCounter& other)
    {
        swap_t(m_nCount, other.m_nCount);
    }

public:
    typename T_COUNT GetCount() const
    {
        return m_nCount;
    }
...
class Node;
template<>
class Node<true, false>
{
protected:
    Node* m_pPrev;
    template<BOOL Prev, BOOL Next, BOOL Head, BOOL Tail>
    friend class ListEngBase;
};
template<>
class Node<false, true>
{
protected:
    Node* m_pNext;
    template<BOOL Prev, BOOL Next, BOOL Head, BOOL Tail>
...
template<class Node, BOOL Head, BOOL Tail>
struct InhHT;
template<class Node>
...
private:
    ...
    BOOL zIsEmpty() const;
    template<>
    BOOL zIsEmpty<true>() const
    {
        return !m_pHead;
    }
    template<>
    BOOL zIsEmpty<false>() const
    {
        return !m_pTail;
    }
    ...
    // Head/Tail set
    template<BOOL vise>
    void zSetHead(Node* pVal);
    template<>
    void zSetHead<true>(Node* pVal)
    {
        zSetHeadEx<Head>(pVal);
    }
    template<>
    void zSetHead<false>(Node* pVal)
    {
        zSetTailEx<Tail>(pVal);
    }
    template<BOOL>
    void zSetHeadEx(Node* pVal)
    {
        m_pHead = pVal;
    }
    template<BOOL>
    void zSetTailEx(Node* pVal)
    {
        m_pTail = pVal;
    }
    template<>
    void zSetHeadEx<false>(Node* pVal)
    {
    }
    template<>
    void zSetTailEx<false>(Node* pVal)
    {
    }
    // Node prev/next retrieve
    template<BOOL vise>
    static Node* zGetNext(Node&);
    template<>
    static Node* zGetNext<true>(Node& node)
    {
        return node.m_pNext;
    }
    template<>
    static Node* zGetNext<false>(Node& node)
    {
        return node.m_pPrev;
    }
    // Node prev/next set
    template<BOOL vise>
    static void zSetNext(Node&, Node* pVal);
    template<>
    static void zSetNext<true>(Node& node, Node* pVal)
    {
        zSetNextEx<Next>(node, pVal);
    }
    template<>
    static void zSetNext<false>(Node& node, Node* pVal)
    {
        zSetPrevEx<Prev>(node, pVal);
    }
    template<BOOL>
    static void zSetNextEx(Node& node, Node* pVal)
    {
        node.m_pNext = pVal;
    }
    template<BOOL>
    static void zSetPrevEx(Node& node, Node* pVal)
    {
        node.m_pPrev = pVal;
    }
    template<>
    static void zSetNextEx<false>(Node& node, Node* pVal)
    {
    }
    template<>
    static void zSetPrevEx<false>(Node& node, Node* pVal)
    {
    }
    // Node prev/next _ASSERT
#ifdef _DEBUG
    template<BOOL vise>
    static void z_ASSERTNext(const Node&, const Node* pVal);
    template<>
    static void z_ASSERTNext<true>(const Node& node, const Node* pVal)
    {
        z_ASSERTNextEx<Next>(node, pVal);
    }
    template<>
    static void z_ASSERTNext<false>(const Node& node, const Node* pVal)
    {
        z_ASSERTPrevEx<Prev>(node, pVal);
    }
    template<BOOL>
    static void z_ASSERTNextEx(const Node& node, const Node* pVal)
    {
        _ASSERT(node.m_pNext == pVal);
    }
    template<BOOL>
    static void z_ASSERTPrevEx(const Node& node, const Node* pVal)
    {
        _ASSERT(node.m_pPrev == pVal);
    }
    template<>
    static void z_ASSERTNextEx<false>(const Node& node, const Node* pVal)
    {
    }
    template<>
    static void z_ASSERTPrevEx<false>(const Node& node, const Node* pVal)
    {
    }
#endif // _DEBUG
       // Swap
    template<BOOL>
    void zSwapHead(ListEngBase& lst)
    {
        swap_t(m_pHead, lst.m_pHead);
    }
    template<BOOL>
    void zSwapTail(ListEngBase& lst)
    {
        swap_t(m_pTail, lst.m_pTail);
    }
    template<>
    void zSwapHead<false>(ListEngBase& lst)
    {
    }
    template<>
    void zSwapTail<false>(ListEngBase& lst)
    {
    }

    template<BOOL vise>
    void zInsertNextEx(Node& node, Node* pPos, Node* pLink)
    {
    ...
    template<BOOL vise>
    void zRemoveNextEx(Node& node, Node* pPos)
    {
...
protected:
    // Inserts
    template<BOOL vise>
    void zInsertNext(Node& node, Node& pos)
    {
    ...
    template<BOOL vise>
    void zInsertNext(Node& node, Node* pPos)
    {
        if (pPos)
    ...
    // Removes
    template<BOOL vise>
    Node* zRemoveNext(Node& pos)
    {
        Node* pNode = zGetNext<vise>(pos);
        _ASSERT(pNode); // node = pos->next
    ...
    Node* zRemoveHead()
    {
        Node* pNode = zGetHead<vise>();
        _ASSERT(pNode); // node = head
...
protected:
    ...
    {
        zDec();
        return Eng::zRemoveNext<vise>(pos);
    }
    template<BOOL vise>
    void zInsertHead(Node& node)
    {
        Eng::zInsertHead<vise>(node);
        zInc();
    }
    template<BOOL vise>
    Node* zRemoveHead()
    {
        zDec();
        return Eng::zRemoveHead<vise>();
    }
    template<BOOL vise>
    void zInsertNext(Node& node, Node* pPos)
    {
        Eng::zInsertNext<vise>(node, pPos);
        zInc();
    }
    template<BOOL vise>
    Node* zRemoveNext(Node* pPos)
    {
        zDec();
        return Eng::zRemoveNext<vise>(pPos);
    }
    Node* zAnyOrderRemove()
    {
        zDec();
        return Eng::zAnyOrderRemove();
    }
...
public:
    ...
    CastNode* GetHead()
    {
        return (CastNode*)m_pHead;
    }
    const CastNode* GetHead() const
    {
        return (const CastNode*)m_pHead;
    }
    ...
    CastNode* GetTail()
    {
        return (CastNode*)m_pTail;
    }
    const CastNode* GetTail() const
    {
        return (const CastNode*)m_pTail;
    }
    ...
    void InsertNext(CastNode& node, CastNode& pos)
    {
        zInsertNext<true>(node, pos);
    }
    CastNode* RemoveNext(CastNode& pos)
    {
        return (CastNode*)zRemoveNext<true>(pos);
    }
    // Must also have the head pointer
    void InsertHead(CastNode& node)
    {
        zInsertHead<true>(node);
    }
    CastNode* RemoveHead()
    {
        return (CastNode*)zRemoveHead<true>();
    }
    void InsertNext(CastNode& node, CastNode* pPos)
    {
        zInsertNext<true>(node, pPos);
    }
    CastNode* RemoveNext(CastNode* pPos)
    {
        return (CastNode*)zRemoveNext<true>(pPos);
    }

    // Must have backward iteration
    void InsertPrev(CastNode& node, CastNode& pos)
    {
        zInsertNext<false>(node, pos);
    }
    CastNode* RemovePrev(CastNode& pos)
    {
        return (CastNode*)zRemoveNext<false>(pos);
    }
    // Must also have the tail pointer
    void InsertTail(CastNode& node)
    {
        zInsertHead<false>(node);
    }
    CastNode* RemoveTail()
    {
        return (CastNode*)zRemoveHead<false>();
    }
    void InsertPrev(CastNode& node, CastNode* pPos)
    {
        zInsertNext<false>(node, pPos);
    }
    CastNode* RemovePrev(CastNode* pPos)
    {
        return (CastNode*)zRemoveNext<false>(pPos);
    }
...
struct NodeEx : public Eng::Node
{
    CastNode* GetNext()
    {
        return (CastNode*)m_pNext;
    }
    const CastNode* GetNext() const
    {
        return (const CastNode*)m_pNext;
    }
    CastNode* GetPrev()
    {
        return (CastNode*)m_pPrev;
    }
    const CastNode* GetPrev() const
    {
        return (const CastNode*)m_pPrev;
    }
...
protected:
    ...
    protected:
        ...
        BOOL zIsBallanceOk() const
        {
            return (m_nBallance >= -1) && (m_nBallance <= 1);
        }
    ...
    template<int nIdx>
    static Node* zGetExtr(Node* pPos)
    {
        while (true)
        {
    ...
    Node* zWalkL(Node& node)
    {
        return zWalk<0>(node);
    }
    Node* zWalkR(Node& node)
    {
        return zWalk<1>(node);
    }
    ...
    void Swap(TreeEngRaw& other)
    {
        swap_t(m_pRoot, other.m_pRoot);
    }
...
public:
    Node* Find(ARG_KEY Key)
    {
        return zFind<true, 0>(Key);
    }
    Node* FindMin()
    {
        return (Node*)zGetExtrRoot<0>();
    }
    Node* FindMax()
    {
        return (Node*)zGetExtrRoot<1>();
    }
    Node* FindSmaller(ARG_KEY Key)
    {
        return zFind<false, -1>(Key);
    }
    Node* FindBigger(ARG_KEY Key)
    {
        return zFind<false, 1>(Key);
    }
    Node* FindExactSmaller(ARG_KEY Key)
    {
        return zFind<true, -1>(Key);
    }
    Node* FindExactBigger(ARG_KEY Key)
    {
        return zFind<true, 1>(Key);
    }
...
protected:
    ...
    Node* zAnyOrderRemove()
    {
        return (Node*)TreeEngRaw::zAnyOrderRemove();
    }

    Node* zWalkL(Node& node)
    {
        return (Node*)TreeEngRaw::zWalkL(node);
    }
    Node* zWalkR(Node& node)
    {
        return (Node*)TreeEngRaw::zWalkR(node);
    }
};
